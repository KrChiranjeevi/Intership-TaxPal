...
@Component({
  ...
  template: `
    <div class="error-page">
      <div class="error-content">
        ...
        <p>You don't have administrator permissions to access this area.</p>
        <div class="error-actions">
          ...
          <a routerLink="/login" class="btn-ghost">
            <span class="material-icons">lock</span> Switch Account
          </a>
        </div>
      </div>
    </div>
  ...
  styles: [`
    ...
    p { color: #94a3b8; margin-bottom: 2rem; max-width: 420px; margin-left: auto; margin-right: auto; }
    ...
    .btn-ghost {
      ...
      text-decoration: none; cursor: pointer; transition: border-color 0.2s, color 0.2s;
