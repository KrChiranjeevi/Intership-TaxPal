...
__name(round, "round");
var lim = /* @__PURE__ */ __name((v, l, h) => Math.max(Math.min(v, h), l), "lim");
function p2b(v) {
...
var h1 = /* @__PURE__ */ __name((b) => hex[b & 15], "h1");
var h2 = /* @__PURE__ */ __name((b) => hex[(b & 240) >> 4] + hex[b & 15], "h2");
var eq = /* @__PURE__ */ __name((b) => (b & 240) >> 4 === (b & 15), "eq");
var isShort = /* @__PURE__ */ __name((v) => eq(v.r) && eq(v.g) && eq(v.b) && eq(v.a), "isShort");
...
var alpha = /* @__PURE__ */ __name((a, f) => a < 255 ? f(a) : "", "alpha");
...
var to = /* @__PURE__ */ __name((v) => v <= 31308e-7 ? v * 12.92 : Math.pow(v, 1 / 2.4) * 1.055 - 0.055, "to");
var from = /* @__PURE__ */ __name((v) => v <= 0.04045 ? v / 12.92 : Math.pow((v + 0.055) / 1.055, 2.4), "from");
...
var toPercentage = /* @__PURE__ */ __name((value, dimension) => typeof value === "string" && value.endsWith("%") ? parseFloat(value) / 100 : +value / dimension, "toPercentage");
var toDimension = /* @__PURE__ */ __name((value, dimension) => typeof value === "string" && value.endsWith("%") ? parseFloat(value) / 100 * dimension : +value, "toDimension");
...
var keyResolvers = {
  ...
  "": (v) => v,
  // default resolvers
  x: /* @__PURE__ */ __name((o) => o.x, "x"),
  y: /* @__PURE__ */ __name((o) => o.y, "y")
};
...
var defined = /* @__PURE__ */ __name((value) => typeof value !== "undefined", "defined");
var isFunction = /* @__PURE__ */ __name((value) => typeof value === "function", "isFunction");
var setsEqual = /* @__PURE__ */ __name((a, b) => {
  if (a.size !== b.size) {
    return false;
  }
  for (const item of a) {
...
var _lookupByKey = /* @__PURE__ */ __name((table, key, value, last2) => _lookup(table, value, last2 ? (index2) => {
  const ti = table[index2][key];
  return ti < value || ti === value && table[index2 + 1][key] === value;
} : (index2) => table[index2][key] < value), "_lookupByKey");
var _rlookupByKey = /* @__PURE__ */ __name((table, key, value) => _lookup(table, value, (index2) => table[index2][key] >= value), "_rlookupByKey");
...
var _toLeftRightCenter = /* @__PURE__ */ __name((align) => align === "start" ? "left" : align === "end" ? "right" : "center", "_toLeftRightCenter");
var _alignStartEnd = /* @__PURE__ */ __name((align, start, end) => align === "start" ? start : align === "end" ? end : (start + end) / 2, "_alignStartEnd");
var _textX = /* @__PURE__ */ __name((align, left, right, rtl) => {
...
var atEdge = /* @__PURE__ */ __name((t) => t === 0 || t === 1, "atEdge");
var elasticIn = /* @__PURE__ */ __name((t, s, p) => -(Math.pow(2, 10 * (t -= 1)) * Math.sin((t - s) * TAU / p)), "elasticIn");
var elasticOut = /* @__PURE__ */ __name((t, s, p) => Math.pow(2, -10 * t) * Math.sin((t - s) * TAU / p) + 1, "elasticOut");
var effects = {
  linear: /* @__PURE__ */ __name((t) => t, "linear"),
  easeInQuad: /* @__PURE__ */ __name((t) => t * t, "easeInQuad"),
  easeOutQuad: /* @__PURE__ */ __name((t) => -t * (t - 2), "easeOutQuad"),
  easeInOutQuad: /* @__PURE__ */ __name((t) => (t /= 0.5) < 1 ? 0.5 * t * t : -0.5 * (--t * (t - 2) - 1), "easeInOutQuad"),
  easeInCubic: /* @__PURE__ */ __name((t) => t * t * t, "easeInCubic"),
  easeOutCubic: /* @__PURE__ */ __name((t) => (t -= 1) * t * t + 1, "easeOutCubic"),
  easeInOutCubic: /* @__PURE__ */ __name((t) => (t /= 0.5) < 1 ? 0.5 * t * t * t : 0.5 * ((t -= 2) * t * t + 2), "easeInOutCubic"),
  easeInQuart: /* @__PURE__ */ __name((t) => t * t * t * t, "easeInQuart"),
  easeOutQuart: /* @__PURE__ */ __name((t) => -((t -= 1) * t * t * t - 1), "easeOutQuart"),
  easeInOutQuart: /* @__PURE__ */ __name((t) => (t /= 0.5) < 1 ? 0.5 * t * t * t * t : -0.5 * ((t -= 2) * t * t * t - 2), "easeInOutQuart"),
  easeInQuint: /* @__PURE__ */ __name((t) => t * t * t * t * t, "easeInQuint"),
  easeOutQuint: /* @__PURE__ */ __name((t) => (t -= 1) * t * t * t * t + 1, "easeOutQuint"),
  easeInOutQuint: /* @__PURE__ */ __name((t) => (t /= 0.5) < 1 ? 0.5 * t * t * t * t * t : 0.5 * ((t -= 2) * t * t * t * t + 2), "easeInOutQuint"),
  easeInSine: /* @__PURE__ */ __name((t) => -Math.cos(t * HALF_PI) + 1, "easeInSine"),
  easeOutSine: /* @__PURE__ */ __name((t) => Math.sin(t * HALF_PI), "easeOutSine"),
  easeInOutSine: /* @__PURE__ */ __name((t) => -0.5 * (Math.cos(PI * t) - 1), "easeInOutSine"),
  easeInExpo: /* @__PURE__ */ __name((t) => t === 0 ? 0 : Math.pow(2, 10 * (t - 1)), "easeInExpo"),
  easeOutExpo: /* @__PURE__ */ __name((t) => t === 1 ? 1 : -Math.pow(2, -10 * t) + 1, "easeOutExpo"),
  easeInOutExpo: /* @__PURE__ */ __name((t) => atEdge(t) ? t : t < 0.5 ? 0.5 * Math.pow(2, 10 * (t * 2 - 1)) : 0.5 * (-Math.pow(2, -10 * (t * 2 - 1)) + 2), "easeInOutExpo"),
  easeInCirc: /* @__PURE__ */ __name((t) => t >= 1 ? t : -(Math.sqrt(1 - t * t) - 1), "easeInCirc"),
  easeOutCirc: /* @__PURE__ */ __name((t) => Math.sqrt(1 - (t -= 1) * t), "easeOutCirc"),
  easeInOutCirc: /* @__PURE__ */ __name((t) => (t /= 0.5) < 1 ? -0.5 * (Math.sqrt(1 - t * t) - 1) : 0.5 * (Math.sqrt(1 - (t -= 2) * t) + 1), "easeInOutCirc"),
  easeInElastic: /* @__PURE__ */ __name((t) => atEdge(t) ? t : elasticIn(t, 0.075, 0.3), "easeInElastic"),
  easeOutElastic: /* @__PURE__ */ __name((t) => atEdge(t) ? t : elasticOut(t, 0.075, 0.3), "easeOutElastic"),
  easeInOutElastic(t) {
    const s = 0.1125;
    const p = 0.45;
  ...
  easeInBounce: /* @__PURE__ */ __name((t) => 1 - effects.easeOutBounce(1 - t), "easeInBounce"),
  easeOutBounce(t) {
    const m = 7.5625;
    const d = 2.75;
    if (t < 1 / d) {
  ...
  easeInOutBounce: /* @__PURE__ */ __name((t) => t < 0.5 ? effects.easeInBounce(t * 2) * 0.5 : effects.easeOutBounce(t * 2 - 1) * 0.5 + 0.5, "easeInOutBounce")
};
...
function applyAnimationsDefaults(defaults3) {
  ...
  defaults3.describe("animation", {
    _fallback: false,
    _indexable: false,
    _scriptable: /* @__PURE__ */ __name((name) => name !== "onProgress" && name !== "onComplete" && name !== "fn", "_scriptable")
  });
...
function applyScaleDefaults(defaults3) {
  defaults3.set("scale", {
    ...
    grid: {
      ...
      drawTicks: true,
      tickLength: 8,
      tickWidth: /* @__PURE__ */ __name((_ctx, options) => options.lineWidth, "tickWidth"),
      tickColor: /* @__PURE__ */ __name((_ctx, options) => options.color, "tickColor"),
      offset: false
    },
    border: {
      display: true,
  ...
  defaults3.describe("scale", {
    _fallback: false,
    _scriptable: /* @__PURE__ */ __name((name) => !name.startsWith("before") && !name.startsWith("after") && name !== "callback" && name !== "parser", "_scriptable"),
    _indexable: /* @__PURE__ */ __name((name) => name !== "borderDash" && name !== "tickBorderDash" && name !== "dash", "_indexable")
  });
  defaults3.describe("scales", {
    _fallback: "scale"
  });
  defaults3.describe("scale.ticks", {
    _scriptable: /* @__PURE__ */ __name((name) => name !== "backdropPadding" && name !== "callback", "_scriptable"),
    _indexable: /* @__PURE__ */ __name((name) => name !== "backdropPadding", "_indexable")
  });
}
...
var defaults = new Defaults({
  _scriptable: /* @__PURE__ */ __name((name) => !name.startsWith("on"), "_scriptable"),
  _indexable: /* @__PURE__ */ __name((name) => name !== "events", "_indexable"),
  hover: {
...
var numberOrZero = /* @__PURE__ */ __name((v) => +v || 0, "numberOrZero");
...
function _addGrace(minmax, grace, beginAtZero) {
  ...
  const keepZero = /* @__PURE__ */ __name((value, add2) => beginAtZero && value === 0 ? 0 : value + add2, "keepZero");
  return {
...
function _createResolver(scopes, prefixes = [
  ...
  const cache = {
    ...
    override: /* @__PURE__ */ __name((scope) => _createResolver([
      scope,
      ...scopes
    ], prefixes, finalRootScopes, fallback), "override")
  };
...
function _attachContext(proxy, context, subProxy, descriptorDefaults) {
  const cache = {
    ...
    setContext: /* @__PURE__ */ __name((ctx) => _attachContext(proxy, ctx, subProxy, descriptorDefaults), "setContext"),
    override: /* @__PURE__ */ __name((scope) => _attachContext(proxy.override(scope), context, subProxy, descriptorDefaults), "override")
  };
  return new Proxy(cache, {
    /**
    * A trap for the delete operator.
...
var readKey = /* @__PURE__ */ __name((prefix, name) => prefix ? prefix + _capitalize(name) : name, "readKey");
var needsSubResolver = /* @__PURE__ */ __name((prop, value) => isObject(value) && prop !== "adapters" && (Object.getPrototypeOf(value) === null || value.constructor === Object), "needsSubResolver");
...
var getScope = /* @__PURE__ */ __name((key, parent2) => key === true ? parent2 : typeof key === "string" ? resolveObjectKey(parent2, key) : void 0, "getScope");
...
var getPoint = /* @__PURE__ */ __name((points, i) => i < points.length && !points[i].skip && points[i], "getPoint");
var getValueAxis = /* @__PURE__ */ __name((indexAxis) => indexAxis === "x" ? "y" : "x", "getValueAxis");
...
var getComputedStyle = /* @__PURE__ */ __name((element) => element.ownerDocument.defaultView.getComputedStyle(element, null), "getComputedStyle");
...
var useOffsetPos = /* @__PURE__ */ __name((x, y, target) => (x > 0 || y > 0) && (!target || !target.shadowRoot), "useOffsetPos");
...
var round1 = /* @__PURE__ */ __name((v) => Math.round(v * 10) / 10, "round1");
...
var getRightToLeftAdapter = /* @__PURE__ */ __name(function(rectX, width) {
  return {
    x(x) {
...
var getLeftToRightAdapter = /* @__PURE__ */ __name(function() {
  return {
    x(x) {
      return x;
    },
...
function propertyFn(property2) {
  ...
  return {
    between: _isBetween,
    compare: /* @__PURE__ */ __name((a, b) => a - b, "compare"),
    normalize: /* @__PURE__ */ __name((x) => x, "normalize")
  };
}
...
var _Animations = class _Animations {
...
var isDirectUpdateMode = /* @__PURE__ */ __name((mode) => mode === "reset" || mode === "none", "isDirectUpdateMode");
var cloneIfNotShared = /* @__PURE__ */ __name((cached, shared) => shared ? cached : Object.assign({}, cached), "cloneIfNotShared");
var createStack = /* @__PURE__ */ __name((canStack, meta, chart) => canStack && !meta.hidden && meta._stacked && {
  keys: getSortedDatasetIndices(chart, true),
  values: null
}, "createStack");
var _DatasetController = class _DatasetController {
...
var DatasetController = _DatasetController;
...
var _BarController = class _BarController extends DatasetController {
  parsePrimitiveData(meta, data, start, count) {
...
var BarController = _BarController;
var _BubbleController = class _BubbleController extends DatasetController {
  initialize() {
    this.enableOptionSharing = true;
    super.initialize();
  }
...
__name(_BubbleController, "BubbleController");
__publicField(_BubbleController, "id", "bubble");
__publicField(_BubbleController, "defaults", {
  datasetElementType: false,
...
__publicField(_BubbleController, "overrides", {
  scales: {
    x: {
      type: "linear"
    },
...
var BubbleController = _BubbleController;
...
var _DoughnutController = class _DoughnutController extends DatasetController {
  constructor(chart, datasetIndex) {
...
__publicField(_DoughnutController, "descriptors", {
  _scriptable: /* @__PURE__ */ __name((name) => name !== "spacing", "_scriptable"),
  _indexable: /* @__PURE__ */ __name((name) => name !== "spacing" && !name.startsWith("borderDash") && !name.startsWith("hoverBorderDash"), "_indexable")
});
...
var DoughnutController = _DoughnutController;
var _LineController = class _LineController extends DatasetController {
  initialize() {
    this.enableOptionSharing = true;
...
var LineController = _LineController;
var _PolarAreaController = class _PolarAreaController extends DatasetController {
  constructor(chart, datasetIndex) {
    super(chart, datasetIndex);
    this.innerRadius = void 0;
    this.outerRadius = void 0;
...
__name(_PolarAreaController, "PolarAreaController");
__publicField(_PolarAreaController, "id", "polarArea");
__publicField(_PolarAreaController, "defaults", {
  dataElementType: "arc",
  animation: {
    animateRotate: true,
    animateScale: true
...
__publicField(_PolarAreaController, "overrides", {
  aspectRatio: 1,
  plugins: {
    legend: {
      labels: {
...
var PolarAreaController = _PolarAreaController;
var _PieController = class _PieController extends DoughnutController {
};
__name(_PieController, "PieController");
__publicField(_PieController, "id", "pie");
__publicField(_PieController, "defaults", {
  cutout: 0,
  rotation: 0,
  circumference: 360,
  radius: "100%"
});
var PieController = _PieController;
var _RadarController = class _RadarController extends DatasetController {
  getLabelAndValue(index2) {
...
var RadarController = _RadarController;
var _ScatterController = class _ScatterController extends DatasetController {
  getLabelAndValue(index2) {
    const meta = this._cachedMeta;
    const labels = this.chart.data.labels || [];
    const { xScale, yScale } = meta;
...
__name(_ScatterController, "ScatterController");
__publicField(_ScatterController, "id", "scatter");
__publicField(_ScatterController, "defaults", {
  datasetElementType: false,
  dataElementType: "point",
  showLine: false,
  fill: false
});
__publicField(_ScatterController, "overrides", {
  interaction: {
    mode: "point"
  },
  scales: {
...
var ScatterController = _ScatterController;
...
var _DateAdapterBase = class _DateAdapterBase {
  /**
...
var DateAdapterBase = _DateAdapterBase;
var adapters = {
...
var _BasePlatform = class _BasePlatform {
...
var BasePlatform = _BasePlatform;
var _BasicPlatform = class _BasicPlatform extends BasePlatform {
  acquireContext(item) {
...
var BasicPlatform = _BasicPlatform;
...
var isNullOrEmpty = /* @__PURE__ */ __name((value) => value === null || value === "", "isNullOrEmpty");
...
var _DomPlatform = class _DomPlatform extends BasePlatform {
  acquireContext(canvas, aspectRatio) {
...
var reverseAlign = /* @__PURE__ */ __name((align) => align === "left" ? "right" : align === "right" ? "left" : align, "reverseAlign");
var offsetFromEdge = /* @__PURE__ */ __name((scale, edge, offset) => edge === "top" || edge === "left" ? scale[edge] + offset : scale[edge] - offset, "offsetFromEdge");
var getTicksLimit = /* @__PURE__ */ __name((ticksLength, maxTicksLimit) => Math.min(maxTicksLimit || ticksLength, ticksLength), "getTicksLimit");
...
var _Scale = class _Scale extends Element {
  constructor(cfg) {
    super();
    this.id = cfg.id;
    this.type = cfg.type;
  ...
  _layers() {
    ...
    if (!this._isVisible() || this.draw !== _Scale.prototype.draw) {
      return [
        {
          z: tz,
          draw: /* @__PURE__ */ __name((chartArea) => {
            this.draw(chartArea);
          }, "draw")
        }
      ];
...
__name(_Scale, "Scale");
var Scale = _Scale;
var _TypedRegistry = class _TypedRegistry {
...
var TypedRegistry = _TypedRegistry;
...
var _PluginService = class _PluginService {
  constructor() {
    this._init = [];
  }
...
var PluginService = _PluginService;
...
var addIfFound = /* @__PURE__ */ __name((set3, obj, key) => {
...
var hasFunction = /* @__PURE__ */ __name((value) => isObject(value) && Object.getOwnPropertyNames(value).some((key) => isFunction(value[key])), "hasFunction");
...
var instances = {};
var getChart = /* @__PURE__ */ __name((key) => {
...
__name(_Chart, "Chart");
__publicField(_Chart, "defaults", defaults);
__publicField(_Chart, "instances", instances);
__publicField(_Chart, "overrides", overrides);
__publicField(_Chart, "registry", registry);
__publicField(_Chart, "version", version);
__publicField(_Chart, "getChart", getChart);
var Chart = _Chart;
...
var _ArcElement = class _ArcElement extends Element {
  circumference;
  endAngle;
  fullCircles;
  innerRadius;
...
__publicField(_ArcElement, "descriptors", {
  _scriptable: true,
  _indexable: /* @__PURE__ */ __name((name) => name !== "borderDash", "_indexable")
});
var ArcElement = _ArcElement;
...
function fastPathSegment(ctx, line, segment, params) {
  ...
  const pointIndex = /* @__PURE__ */ __name((index2) => (start + (reverse2 ? ilen - index2 : index2)) % count, "pointIndex");
...
__name(draw, "draw");
var _LineElement = class _LineElement extends Element {
  constructor(cfg) {
    super();
    this.animated = true;
    this.options = void 0;
...
__publicField(_LineElement, "descriptors", {
  _scriptable: true,
  _indexable: /* @__PURE__ */ __name((name) => name !== "borderDash" && name !== "fill", "_indexable")
});
var LineElement = _LineElement;
...
var _PointElement = class _PointElement extends Element {
  parsed;
  skip;
  stop;
  constructor(cfg) {
...
var PointElement = _PointElement;
...
var _BarElement = class _BarElement extends Element {
  constructor(cfg) {
    super();
    this.options = void 0;
...
__name(containsDefaultColorsDefenitions, "containsDefaultColorsDefenitions");
var plugin_colors = {
  id: "colors",
  defaults: {
    enabled: true,
...
var plugin_decimation = {
  ...
  beforeElementsUpdate: /* @__PURE__ */ __name((chart, args, options) => {
    if (!options.enabled) {
    ...
    chart.data.datasets.forEach((dataset, datasetIndex) => {
      ...
      if (isNullOrUndef(_data)) {
        ...
        Object.defineProperty(dataset, "data", {
          ...
          set: /* @__PURE__ */ __name(function(d) {
            this._data = d;
          }, "set")
        });
      }
...
var _simpleArc = class _simpleArc {
  constructor(opts) {
    this.x = opts.x;
    this.y = opts.y;
...
__name(_simpleArc, "simpleArc");
var simpleArc = _simpleArc;
...
__name(clipHorizontal, "clipHorizontal");
...
var getBoxSize = /* @__PURE__ */ __name((labelOpts, fontSize) => {
...
var itemsEqual = /* @__PURE__ */ __name((a, b) => a !== null && b !== null && a.datasetIndex === b.datasetIndex && a.index === b.index, "itemsEqual");
var _Legend = class _Legend extends Element {
  constructor(config) {
    super();
    this._added = false;
    this.legendHitBoxes = [];
...
var plugin_legend = {
  ...
  defaults: {
    ...
    onLeave: null,
    labels: {
      color: /* @__PURE__ */ __name((ctx) => ctx.chart.options.color, "color"),
      boxWidth: 40,
      padding: 10,
      generateLabels(chart) {
  ...
  descriptors: {
    _scriptable: /* @__PURE__ */ __name((name) => !name.startsWith("on"), "_scriptable"),
    labels: {
      _scriptable: /* @__PURE__ */ __name((name) => ![
        "generateLabels",
        "filter",
        "sort"
      ].includes(name), "_scriptable")
    }
  }
};
var _Title = class _Title extends Element {
  constructor(config) {
    super();
    this.chart = config.chart;
    this.options = config.options;
...
var _Tooltip = class _Tooltip extends Element {
  constructor(config) {
    super();
    this.opacity = 0;
    this._active = [];
...
var plugin_tooltip = {
  ...
  defaults: {
    ...
    caretSize: 5,
    cornerRadius: 6,
    boxHeight: /* @__PURE__ */ __name((ctx, opts) => opts.bodyFont.size, "boxHeight"),
    boxWidth: /* @__PURE__ */ __name((ctx, opts) => opts.bodyFont.size, "boxWidth"),
  ...
  descriptors: {
    _scriptable: /* @__PURE__ */ __name((name) => name !== "filter" && name !== "itemSort" && name !== "external", "_scriptable"),
    _indexable: false,
    callbacks: {
      _scriptable: false,
      _indexable: false
...
var addIfString = /* @__PURE__ */ __name((labels, raw, index2, addedLabels) => {
...
var validIndex = /* @__PURE__ */ __name((index2, max2) => index2 === null ? null : _limitValue(Math.round(index2), 0, max2), "validIndex");
...
var _CategoryScale = class _CategoryScale extends Scale {
  constructor(cfg) {
    super(cfg);
...
var CategoryScale = _CategoryScale;
...
var _LinearScaleBase = class _LinearScaleBase extends Scale {
  constructor(cfg) {
    super(cfg);
    this.start = void 0;
    this.end = void 0;
  ...
  handleTickRangeOptions() {
    ...
    const setMin = /* @__PURE__ */ __name((v) => min2 = minDefined ? min2 : v, "setMin");
    const setMax = /* @__PURE__ */ __name((v) => max2 = maxDefined ? max2 : v, "setMax");
    if (beginAtZero) {
...
var LinearScaleBase = _LinearScaleBase;
var _LinearScale = class _LinearScale extends LinearScaleBase {
  determineDataLimits() {
...
var LinearScale = _LinearScale;
var log10Floor = /* @__PURE__ */ __name((v) => Math.floor(log10(v)), "log10Floor");
var changeExponent = /* @__PURE__ */ __name((v, m) => Math.pow(10, log10Floor(v) + m), "changeExponent");
...
var _LogarithmicScale = class _LogarithmicScale extends Scale {
  constructor(cfg) {
    super(cfg);
    this.start = void 0;
    this.end = void 0;
...
var LogarithmicScale = _LogarithmicScale;
...
var _RadialLinearScale = class _RadialLinearScale extends LinearScaleBase {
  constructor(cfg) {
    super(cfg);
    this.xCenter = void 0;
    this.yCenter = void 0;
...
var RadialLinearScale = _RadialLinearScale;
var INTERVALS = {
  millisecond: {
    common: true,
    size: 1,
...
var _TimeScale = class _TimeScale extends Scale {
  constructor(props) {
    super(props);
    this._cache = {
      data: [],
...
var _TimeSeriesScale = class _TimeSeriesScale extends TimeScale {
  constructor(props) {
    super(props);
    this._table = [];
    this._minPos = void 0;
...
var TimeSeriesScale = _TimeSeriesScale;
...
_ThemeService.ɵfac = /* @__PURE__ */ __name(function ThemeService_Factory(__ngFactoryType__) {
...
var _BaseChartDirective = class _BaseChartDirective {
  ...
  getChartOptions() {
    return merge_default({
      onHover: /* @__PURE__ */ __name((event, active) => {
      ...
      onClick: /* @__PURE__ */ __name((event, active) => {
...
__name(_BaseChartDirective, "BaseChartDirective");
_BaseChartDirective.ɵfac = /* @__PURE__ */ __name(function BaseChartDirective_Factory(__ngFactoryType__) {
...
var builtInDefaults = {
  ...
  datasets: {
    line: {
      backgroundColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.datasetIndex), 0.4), "backgroundColor"),
      borderColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.datasetIndex), 1), "borderColor"),
      pointBackgroundColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.datasetIndex), 1), "pointBackgroundColor"),
      pointBorderColor: "#fff"
    },
    bar: {
      backgroundColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.datasetIndex), 0.6), "backgroundColor"),
      borderColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.datasetIndex), 1), "borderColor")
    },
    get radar() {
      return this.line;
    ...
    doughnut: {
      backgroundColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.dataIndex), 0.6), "backgroundColor"),
      borderColor: "#fff"
    },
    get pie() {
    ...
    polarArea: {
      backgroundColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.dataIndex), 0.6), "backgroundColor"),
      borderColor: /* @__PURE__ */ __name((context) => rgba(generateColor(context.dataIndex), 1), "borderColor")
    },
    get bubble() {
      return this.doughnut;
    },
...
__name(_NgChartsConfiguration, "NgChartsConfiguration");
_NgChartsConfiguration.ɵfac = /* @__PURE__ */ __name(function NgChartsConfiguration_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgChartsConfiguration)();
}, "NgChartsConfiguration_Factory");
...
__name(_NgChartsModule, "NgChartsModule");
_NgChartsModule.ɵfac = /* @__PURE__ */ __name(function NgChartsModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _NgChartsModule)(ɵɵinject(NgChartsConfiguration, 8));
}, "NgChartsModule_Factory");
